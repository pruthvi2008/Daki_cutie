...
from ShogunXRobot.hacking_script import PM_START_TEXT
from redis import StrictRedis
...
LOGGER = logging.getLogger("[ShogunXRobot]")
...
if ENV:
    ...
    DB_URI = os.environ.get('postgres://rzgeatqi:CLn2r-lMpIzyKF9gRv5oPPHwLZRL1U-e@suleiman.db.elephantsql.com/rzgeatqi')
    ...
    SUPPORT_CHAT = os.environ.get('SUPPORT_CHAT', "@Scythe_Support")
    ...
    BOT_NAME = os.environ.get("BOT_NAME", 'Raiden') # Name Of your Bot.4
    BOT_USERNAME = os.environ.get("BOT_USERNAME", "ShogunXRobot") # Bot Username
    ...
    from ShogunXRobot.config import Development as Config
    TOKEN = Config.TOKEN
...
print("[ShogunXRobot]: Initializing AIOHTTP Session")
aiohttpsession = ClientSession() 

#install arq
print("[ShogunXRobot]: Initializing ARQ Client")
arq = (ARQ_API_URL, ARQ_API_KEY, aiohttpsession)
updater = tg.Updater(TOKEN, workers=WORKERS, use_context=True)
telethn = TelegramClient(MemorySession(), API_ID, API_HASH)
pbot = Client("ShogunXRobotpbot", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
from ShogunXRobot.modules.helper_funcs.handlers import (CustomCommandHandler,
